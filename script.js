...
function switchTab(tab, eventTarget) {
  ...
  ["playTab", "createTab", "manageTab", "reportsTab", "teacherScoresTab", "principalTab", "leaderboardTab"].forEach(id => {
    const el = document.getElementById(id);         
    if (el) el.classList.add("hidden");         
  });
  ...
  container.innerHTML = `
    <div id="certCaptureElement" style="width: 900px; padding: 40px; border: 10px solid #003366; background: #ffffff; text-align: center; font-family: 'Segoe UI', Arial, sans-serif; box-sizing: border-box; color: #000000; margin: 0 auto;">
      <div style="border: 2px solid #e65100; padding: 25px;">
        <h1 style="color: #003366; font-size: 30px; margin: 0 0 8px 0; font-weight: bold;">ஹரி மணி பள்ளி (HariMani School)</h1>
        <h3 style="color: #e65100; font-size: 18px; margin: 0 0 20px 0; text-transform: uppercase; letter-spacing: 1px;">பாராட்டுச் சான்றிதழ் (Certificate of Achievement)</h3>
